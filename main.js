...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.target = this.physics.add.image(0, 0, "gift").setOrigin(0, 0);
  ...
  update() {
    ...
    this.textTime.setText(`Quedan: ${Math.round(this.remainingTime).toString()} sg`)
  ...
  gameOver(){
    ...
    if(this.points >=10){
      ...
      gameWinLoseSpan.textContent= "Ganaste! 😊"

    }else{
      gameEndScoreSpan.textContent = this.points
      gameWinLoseSpan.textContent= "Perdiste! 😭"
    }
